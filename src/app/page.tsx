...
// // Helper component for an upload icon
// const UploadIcon = () => (
...
// // Helper component for an error icon
// const ErrorIcon = () => (
...
//               ${isDragging ? 'border-green-500 bg-green-50' : 'border-slate-300 bg-slate-50 hover:bg-slate-100'}`}
...
//             disabled:bg-slate-400 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105"
//           >
